...
##下面需要修改
SITE_TITLE = u"lyyyuna's world" #博客标题
SITE_TITLE2 = u"lyyyuna's world" #显示在边栏上头（有些模板用不到）
SITE_SUB_TITLE = u"电子 电气 数值分析 研究一切好玩的事物" #副标题
KEYWORDS = u"电子, 电气, 计算机 EECS" #博客关键字
SITE_DECR = u"这是运行在SAE上的个人博客，记录生活，记录工作" #博客描述，给搜索引擎看
ADMIN_NAME = u"lyyyuna" #发博文的作者
NOTICE_MAIL = u"lyyyuna@gmail.com" #常用的，容易看到的接收提醒邮件，如QQ 邮箱，仅作收件用

###配置邮件发送信息，提醒邮件用的，必须正确填写，建议用Gmail
MAIL_FROM = 'lyyyuna@gmail.com' #xxx@gmail.com
MAIL_SMTP = 'smtp.gmail.com'
MAIL_PORT = 587
MAIL_PASSWORD = '' #你的邮箱登录密码，用以发提醒邮件
